...
int main() {
    ...
    std::shared_ptr<CreateImageProcessor> createImageProcessor = CreateImageProcessor::createCreateImageProcessor(3000, 2001, 288, 288, 200, 0.8f, "masks.jpg", sam3ModelContext);
